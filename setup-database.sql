...
CREATE POLICY "Allow public read on packages" ON public.packages
    FOR SELECT USING (true);

CREATE POLICY "Allow public read on destinations" ON public.destinations
    FOR SELECT USING (true);

-- Allow anyone to subscribe to newsletter
CREATE POLICY "Allow public insert on newsletter_subscriptions" ON public.newsletter_subscriptions
    FOR INSERT WITH CHECK (true);

-- Allow anyone to read team members and testimonials
CREATE POLICY "Allow public read on team_members" ON public.team_members
    FOR SELECT USING (true);
...
-- Insert sample data
INSERT INTO public.packages (title, subtitle, description, duration, group_size, destinations, features, highlights, is_popular, slug) VALUES
...
INSERT INTO public.destinations (name, title, subtitle, description, duration, best_time, rating, highlights, slug) VALUES
...
INSERT INTO public.testimonials (name, location, text, trip, rating, is_featured, order_index) VALUES
